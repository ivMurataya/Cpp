...
int main(){
	...
	p_dog_1 : 0000000000000000 // moved the pointer and original pointing to null
...
//---------------------------------------------------------------------------------------------------
    ...
    std::unique_ptr<Dog> p_dog_2 = std::make_unique<Dog>("Dog1");
	...
	Destructor for dog Dog1 called
	Doing something , p_dog_1 points to :  0000000000000000
	*/
...
/*
	...
	unique_ptr address(in) : 000000DD03FDF668
	delimiter
	unique_ptr address(out) : 000000DD03FDF668
	Dog [ name : Function Local ]

	Constructor for dog Function Local called.
	unique_ptr address(in) : 000000DD03FDF6D0
	Dog [ name : Function Local ]

...
int main(){
	...
	/*
	Constructor for dog Halz called.
	shared_ptr_int_1 use count : 1
	shared_ptr_dog_1 use count : 1
	unique_ptr_int_1 : false
	unique_ptr_dog_1 : false
	unique_ptr_int_1 : 0000000000000000
	unique_ptr_dog_1 : 0000000000000000
	 ------------------
	*/
	...
	/*
	Making copies...
	shared_ptr_int_1 use count : 2
	shared_ptr_dog_1 use count : 2
	shared_ptr_int_3 use count : 2
	shared_ptr_dog_3 use count : 2
	*/
	...
	/*
	Returning unique_ptr from function to unique ptr
	Constructor for dog Phil called.
	unique_ptr_dog_2 dog name : Phil

	Returning unique_ptr from function to shared ptr
	Constructor for dog Phil called.
	shared_ptr_dog_4 name    : Phil
	shared_ptr_dog_4 use count : 1
	Destructor for dog Phil called
	Destructor for dog Phil called
	Destructor for dog Halz called
	*/

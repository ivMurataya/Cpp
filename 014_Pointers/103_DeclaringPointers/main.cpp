...
int main() {
	...
	int* p_number5{}, other_int_var{}; // A pointer and a regular Integer
	...
	std::cout << "sizeof(p_number6) : " << sizeof(p_number6) << std::endl; //8 
	std::cout << "sizeof(other_int_var6) : " << sizeof(other_int_var6) << std::endl; //4
...
sizeof(int*) : 8
sizeof(p_number1) : 8
sizeof(p_fractional_number1) : 8
sizeof(p_number5) : 8
sizeof(other_int_var) : 4
sizeof(p_number6) : 8
sizeof(other_int_var6) : 4
Int var : 43
p_int (Address in memory)  : 000000F216B7FB14
p_int (with different address)  : 000000F216B7FB34
value : 56
*/

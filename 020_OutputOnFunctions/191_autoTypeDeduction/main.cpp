...
int main() {
	...
	std::cout << "some_var : " << some_var1 << std::endl; //55.5
	...
	auto& z = some_var2_ref; // z is deduced as a double reference
	++z;

	std::cout << "sizeof(some_var2) : " << sizeof(some_var2) << std::endl; // 8
	std::cout << "sizeof(some_var2_ref) : " << sizeof(some_var2_ref) << std::endl; // 8
	std::cout << "sizeof(z) : " << sizeof(z) << std::endl; // 8
	std::cout << "&some_var2 : " << &some_var2 << std::endl;// 0xabc123
	std::cout << "&some_var2_ref : " << &some_var2_ref << std::endl;// 0xabc123
	std::cout << "&z : " << &z << std::endl;// 0xabc123
	std::cout << "some_var2 : " << some_var2 << std::endl; // 56.5
	std::cout << "some_var2_ref : " << some_var2_ref << std::endl; //56.5
	...
	const double i_am_const2{ 71.2 };
	const double& my_ref{ i_am_const2 };
	...
	std::cout << "const  : " << i_am_const2 << std::endl;
	std::cout << "const_ref : " << my_ref << std::endl;
...
sizeof(some_var) : 8
sizeof(x) : 8
&some_var : 0000004EE4B6F658
&x : 0000004EE4B6F678
 some_var : 55.5
 x : 55.5
----------------------
sizeof(some_var) : 8
sizeof(some_var_ref) : 8
sizeof(y) : 8
&some_var : 0000004EE4B6F698
&some_var_ref : 0000004EE4B6F698
&y : 0000004EE4B6F6B8
some_var : 55.5
some_var_ref : 55.5
y : 56.5
----------------------
sizeof(some_var2) : 8
sizeof(some_var2_ref) : 8
sizeof(z) : 8
&some_var2 : 0000004EE4B6F6D8
&some_var2_ref : 0000004EE4B6F6D8
&z : 0000004EE4B6F6D8
some_var2 : 56.5
some_var2_ref : 56.5
z : 56.5

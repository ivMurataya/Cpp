...
int main() {
	...
	std::cout << "2d array sze : " << std::size(weights) << std::endl;

	std::cout << "2d array sum : " << result << std::endl;


	result = sum_3d(weights_3d, std::size(weights_3d)); //std::size returns the size of the first paramenter
	std::cout << "2d array sze : " << std::size(weights_3d) << std::endl;

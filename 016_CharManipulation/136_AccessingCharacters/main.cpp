...
For loop with array index notation :
str1(for loop) :  H e l l o   t h e r e

Using range based for loop :
str1(range based for loop) :  H e l l o   t h e r e

Using the std::string::at() method :
str1 : (for loop with at()) :  H e l l o   t h e r e
str1(modified) : Ballo there
The front char in str2 is : T
The back char in str2 is : g
str2 : rhe Phoenix Kind
Wrapped c string : The Phoenix King

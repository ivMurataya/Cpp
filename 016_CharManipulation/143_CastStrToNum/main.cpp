...
int main(){
   ...
   //std::string to number (integral types)
	...
	std::cout << "int_var : " << int_var2 << std::endl;
	std::cout << "sizeof(int_var) : " << sizeof(int_var2) << std::endl;
	...
	//std::string number_str2 = "-34.567"; // Resulting unsigned long and long long underflow
	...
	long double long_double_var = std::stold(number_str3);
...
double_var : 34.567
sizeof(double_var) : 8
long_double_var : 34.567
sizeof(long_double_var) : 8 

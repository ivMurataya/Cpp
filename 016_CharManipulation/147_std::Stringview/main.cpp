...
int main(){
   ...
   //String_view shouldn't outlive whatever it is viewing
    ...
    
    {
        ...
        //string4 goes out of scope here. Undefined Behavior
    }
...
/*
address of string : 0000003E2CCFF398
address of string1 : 0000003E2CCFF3D8
address of string2 : 0000003E2CCFF418
--------------------------------------------------------
Size of string_view : 16
size of sv1 : 16
sv : Hellooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
sv1 : Hellooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
sv2 : Hellooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
--------------------------------------------------------
sv3 : String litteral
sv4 : Regular std::string
sv5 : Regular C-String
sv6 : Char array
sv7 (constructed from other string_view) : String litteral
Non null terminated string with std::string_view : Huge
--------------------------------------------------------
word : Dog
Changing data...
word : Dot
--------------------------------------------------------
sv10 : The animals have left the region
View with removed prefix(4) : animals have left the region
View with removed suffix(10) : animals have left
Original sv10 viewed string : The animals have left the region
--------------------------------------------------------
INSIDE --- sv11 is viewing : Hello there
OUTSIDE --- sv1 is viewing : ello there
--------------------------------------------------------
sv13 : Ticket
std::strlen(sv13.data()) : 6
--------------------------------------------------------
ck has 4 characters(s)
sv14.data() is cket
sv14 is ck
--------------------------------------------------------
Hello has 41 characters(s)
sv15.data is  : Hello╠╠╠╠╠╠╠╠╠╠╠╠╠╠╠╠╠╠╠╠╠╠╠╠╠╠╠╠╠╠╠Σ≈╧,>
sv15 is : Hello
--------------------------------------------------------
sv16 is 35 characters long
The front character is : T
The back character is : a
Substring : There is a huge forest
--------------------------------------------------------

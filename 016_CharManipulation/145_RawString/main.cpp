...
int main(){
  ...
  std::string to_do_list2 =   R"(Clean the house
Walk the dog
	Do Laundry
	Pick groceries
...
windows_path1 : D:\sandbox\testProject\hello.txt
linux_path1 : /home/username/files/hello.txt
hint1 : "\\" escapes a backslash character like \.
sentence : The message was "(Stay out of this!)"

...
std::isblank :
message : Hello there. How are you doing? The sun is shining.
Found a blank character at index : [5]
Found a blank character at index : [12]
Found a blank character at index : [16]
Found a blank character at index : [20]
Found a blank character at index : [24]
Found a blank character at index : [31]
Found a blank character at index : [35]
Found a blank character at index : [39]
Found a blank character at index : [42]
In total we found 9 blank characters.
std::islower and std::isupper :

Original string  : The C++ Programming Language is one of the most used on the Planet
 h e r o g r a m m i n g a n g u a g e i s o n e o f t h e m o s t u s e d o n t h e l a n e t
Found 47 lowercase characters and 5 uppercase characters.

std::isdigit :
statement : Mr Hamilton owns 221 cows. That's a lot of cows! The kid exclamed.
Found digit : 2
Found digit : 2
Found digit : 1
Found 3 digits in the statement string

std::tolwer and std::toupper:
Original string : Home. The feeling of belonging
Uppercase string : HOME. THE FEELING OF BELONGING
Lowercase string : home. the feeling of belonging

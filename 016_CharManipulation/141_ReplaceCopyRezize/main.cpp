...
str1 : Finding Nemo
Replacing...
str1 : Searcing For Nemo
str2 : Finding Nemo
Replacing...
str2 : Searching For Nemo
std::size(txt4) : 15
...
str_a : This is a string stored in A
str_b : This is a string stored in B and it's really great to be able to do that.
str_a.size() :28
str_a.capaity() : 31
str_b.size() :73
str_b.capaity() : 79
Swapping...
str_a : This is a string stored in B and it's really great to be able to do that.
str_b : This is a string stored in A
str_a.size() :73
str_a.capaity() : 79
str_b.size() :28
str_b.capaity() : 31

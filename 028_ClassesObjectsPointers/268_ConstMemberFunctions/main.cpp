...
void function_taking_dog(Dog dog){
    std::cout << "Internal Dog func " << std::endl;
...
void function_taking_const_dog_ref(const Dog& const_dog_ref){
    ...
    std::cout << "function_taking_const_dog_ref " << std::endl;
...
void function_taking_pointer_to_const_dog(const Dog* const_p_dog){
    ...
    std::cout << "Taking pointer to const funct " << std::endl;
...
int main(){
    ...
    //function_taking_dog_ref(dog1); // Compiler error doesnt work as trying to modify an const obj


    //will work as were not modifyng the object
...
/*
address of object: 0000008E195DF758
Dog (0000008E195DF758) : [ name : Fluffy, breed : Shepherd, age : 2]
Internal Dog func
Dog (0000008E195DF800) : [ name : Internal dog, breed : Shepherd, age : 2]
function_taking_const_dog_ref
Dog (0000008E195DF758) : [ name : Fluffy, breed : Shepherd, age : 2]
Taking pointer to const funct
Dog (0000008E195DF758) : [ name : Fluffy, breed : Shepherd, age : 2]

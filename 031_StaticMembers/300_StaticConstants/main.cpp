...
int main(){
	...
	Cylinder cylinder1(3.3,10.0, 99.4);
...
Other constants
Int constant : 5
Color(enum) constant : 1
Char ptr constant : CString here
arr[2] : 30
float constant : 6.98
str_arr[1] : String2

Can't modify those static constants

raw constants
WEIRD_FLOAT : 99.4
WEIRD_C_STRING : Weird
WEIRD_INT_ARRAY[3] : 40

Constant initialized with other constant
BIRD_WEIGHT_CONSTANT : 6.98

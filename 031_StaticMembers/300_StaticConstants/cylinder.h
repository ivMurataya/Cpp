...
public : 
    ...
    // Static const variables belongs to the blueprint of the class
	...
	//Not static
    // These variables belongs to each object
    ...
    //Constructors
    Cylinder()= default;
    Cylinder(double radius_param , double height_param, float extra );
